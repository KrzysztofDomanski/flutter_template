...
import 'package:powersync_repository/src/supabase_connector.dart';
...
class PowersyncRepository {
  /// {@macro powersync_repository}
  PowersyncRepository({required this.env});

  /// Provides access to the environment values
  final EnvValue env;
  ...
  Future<String> getDatabasePath() async {
    ...
    return join(dir.path, 'flutter-template-app.db');
  }
